# DO NOT EDIT — generated from tests/_async/conftest.py by scripts/gen_sync.py.
# Run `python scripts/gen_sync.py` (or rebuild the package) to regenerate.

"""Test fixtures + a fake postgrest-py-shaped client.
...
from supabase_orm._sync._client import set_client
